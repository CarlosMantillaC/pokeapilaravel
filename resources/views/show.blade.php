...
@section('content')
    ...
    <div class="min-h-screen bg-theme">
        <div class="container mx-auto p-4 sm:px-6 lg:px-60">
            ...
            <div class="dark:bg-gray-400/30 bg-white p-4 sm:p-6 md:p-8 lg:p-12 rounded-xl shadow-md">
                <div class="text-center">
                    <img src="{{ $pokemon['sprites']['other']['official-artwork']['front_default'] ?? $pokemon['sprites'] }}"
